...
class OutputFormat {
	...
	*/
	...
	public function __call($sMethodName, $aArguments) {
		...
		} else if(method_exists('\\seraph_accel\\Sabberworm\\CSS\\OutputFormatter', $sMethodName)) {
	...
	*/
	public function implode($sSeparator, $aValues, $bIncreaseLevel = false) {
		...
		foreach($aValues as $mValue) {
			...
			if($mValue instanceof \seraph_accel\Sabberworm\CSS\Renderable) {
