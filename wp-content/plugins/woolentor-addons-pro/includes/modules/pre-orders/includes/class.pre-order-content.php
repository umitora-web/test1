...
class Woolentor_Pre_Order_Content extends Woolentor_Pre_Orders{
    ...
    public function pre_order_content( $product_id ){
        ...
        $availability_date_text = $this->get_saved_data( $product_id, 'availability_date', 'availability_date', 'Available on: {availability_date}' );
            ...
            <div class="woolentor-pre-order-area">
                <?php
                    ...
                    if( $show_countdown === 'on' && ! empty( $pre_order_date ) ){
                        ?>
                            <div class="woolentor-pre-order-countdown" data-countdown="<?php echo esc_attr( $pre_order_end_date ); ?>" data-customlavel='<?php echo wp_json_encode( $data_customlavel ) ?>'></div>
                        <?php
                    }
                ?>
            </div>
