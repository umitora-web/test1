...
class Woolentor_Custom_Meta_Fields{
    ...
    public function product_woolentor_tab( $tabs ){
        ?>
            <style>
                #woocommerce-product-data ul.wc-tabs li.woolentor_product_data_tab_tab a::before {
                    content: '';
                    background-image: url(<?php echo WOOLENTOR_ADDONS_PL_URL . 'includes/admin/assets/images/logo.png'; ?>);
                    width: 18px;
                    height: 18px;
                    ...
                    <div class="options_group">
                        ...
                        <?php
                            ...
                            echo '<div class="woolentor-pre-order-fields '.$wrapper_class.'">';
                                ...
                                // woocommerce_wp_text_input( 
                                //     [
                                //         'id'          => 'woolentor_pre_order_limit',
                                //         'label'       => esc_html__( 'Maximum Order limit', 'woolentor-pro' ),
                                //         'placeholder' => esc_html__( 'Maximum Order limit', 'woolentor-pro' ),
                                //         'value'       => $this->get_saved_data( $post->ID, 'woolentor_pre_order_limit', 'woolentor_pre_order_limit', 'woolentor_pre_order_settings', '' ),
                                //     ] 
                                // );
    ...
    public function save_woolenor_product_meta( $post_id ){
        ...
        if( wp_verify_nonce( sanitize_key( $_POST['woocommerce_meta_nonce'] ), 'woocommerce_save_data' ) ){
            ...
            if( ( woolentor_get_option_pro( 'enable', 'woolentor_pre_order_settings', 'off' ) == 'on' ) ){
                ...
                // $pre_order_limit = !empty( $_POST['woolentor_pre_order_limit'] ) ? sanitize_text_field( $_POST['woolentor_pre_order_limit'] ) : '';
                // update_post_meta( $post_id, 'woolentor_pre_order_limit', $pre_order_limit );
            ...
            // delete_post_meta ( $post_id, 'woolentor_pre_order_limit' );
